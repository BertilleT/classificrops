...
def compare(handmade,computed,threshold, place):
    ...
    compare = pd.merge(compare, computed, on ='ID_CROPS_'+place)
    compare['ID_GROUP_ICC_computed'] = compare['ID_GROUP_ICC']
    ...
    #compare = compare.filter(['ID_GROUP_ICC_handmade', 'ID_GROUP_ICC_computed'])
    #print(compare)
    #return compare
