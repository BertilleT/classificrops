...
Nicolas_df = pd.read_csv("../../../data/FR/handmade_Nicolas_detailed.csv", encoding= 'unicode_escape')
Bertille_df = pd.read_csv("../../../data/FR/handmade_Bertille_light.csv")
...
compare_df.drop(columns=['ICC_REM','ID_GROUP_FR'], axis=1, inplace=True)
...
m.to_csv("../../../data/FR/compare_Bertille_Nicolas.csv")
