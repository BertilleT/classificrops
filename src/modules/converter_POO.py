import pandas as pd
import numpy as np
#this script is a first step to write the converter script with an object oriented approach. 
#the code could be more easily adaptable,modulable and understable. 
#to be continue
